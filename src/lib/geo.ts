...
const EIRCODE_CENTROIDS: Record<string, [number, number]> = {
  ...
  N37: [53.5244, -7.3428], N39: [53.6978, -7.5583], N91: [53.3831, -7.536],
  ...
  P85: [51.6536, -9.1358],
  // Kerry
  V92: [52.2593, -9.6966], V93: [52.0606, -9.5033], V94: [52.3281, -9.4731],
  // Limerick city & county
  V94: [52.668, -8.6305], // overwrite Kerry V94 — Limerick city wins
  // Tipperary
  ...
  N23: [53.0861, -7.5739], R35: [53.1667, -7.4781],
  // Westmeath
  N91: [53.5278, -7.3422], // Mullingar area
  // Galway
