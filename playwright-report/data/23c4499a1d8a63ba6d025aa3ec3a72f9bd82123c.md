...
- Name: 01-homepage.spec.ts >> 首页 >> How it works 四步说明可见
- Location: ierepair/tests/smoke/01-homepage.spec.ts:35:7
...
Locator: getByText('Search').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Search').first()
