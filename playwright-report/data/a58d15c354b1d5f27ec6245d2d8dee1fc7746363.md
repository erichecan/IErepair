...
- Name: 01-homepage.spec.ts >> 首页 >> 搜索框输入关键词后点击 Search 跳转搜索页
- Location: ierepair/tests/smoke/01-homepage.spec.ts:28:7
...
Call log:
  - waiting for getByPlaceholder('iPhone 15 screen repair…')
