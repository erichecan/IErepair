...
- Name: 01-homepage.spec.ts >> 首页 >> 可以加载并显示搜索框
- Location: ierepair/tests/smoke/01-homepage.spec.ts:8:7
...
Locator: getByText('IERepair').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('IERepair').first()
